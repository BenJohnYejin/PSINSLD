function [] =CreatWordBodyOri(myWord,myDoc,fileName,j,titleHead)
...
glvs;
    vpGNSS0 = data(:,[23:24,18,13:15,9:11,1]);
    vpGNSS0(end-100*100:end,:)=[];
    base0 = data(:,[23:25,26:28,20:22,1]);
    %dy
%     base0(:,9) = base0(:,9)-13.5;
%     base0(:,6) = -base0(:,6);
    
    myfigure;err=avpcmpplot(vpGNSS0(vpGNSS0(:,4)>0.001,:),base0(base0(:,7)>0.001,:), 'mu');
...
glvs;
    ...
    myfigure;plot(OD(indexOD,end),OD(indexOD,1),'r.-');
