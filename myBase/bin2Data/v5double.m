...
% Example:
%    v5=[100;2000;-30;3000;300]; v1=v5double(v5); [v5,v5double(v1)]
...
% 28/05/2022
    ...
    if n>1  % v5->v1
        ...
        v5v1(v5v1>990) = 991;  v5v1(v5v1<0) = 0;
        v1v5 = round(v5v1(:,1)) + round(v5v1(:,2))/1e3 + round(v5v1(:,3))/1e6 + round(v5v1(:,4))/1e9 + round(v5v1(:,5))/1e12;
    else % v1->v5
        v1v5(:,1) = floor(v5v1);  v5v1=(v5v1-v1v5(:,1))*1e3;
        v1v5(:,2) = floor(v5v1);  v5v1=(v5v1-v1v5(:,2))*1e3;
        v1v5(:,3) = floor(v5v1);  v5v1=(v5v1-v1v5(:,3))*1e3;
        v1v5(:,4) = floor(v5v1);  v5v1=(v5v1-v1v5(:,4))*1e3;
        v1v5(:,5) = floor(v5v1);
