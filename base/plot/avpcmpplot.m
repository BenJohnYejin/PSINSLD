...
global glv
    ...
    if ischar(varargin{end})
        ...
        elseif strcmp(varargin{end},'mu')==1, phi_mu = 'mu'; varargin = varargin(1:end-1); end
    end
...
%                 subplot(122), hold on, plot(t, err(:,1:2)/glv.min, strk, 'LineWidth',2); xygo('mu'); mylegend('mux','muy');
        ...
        case 'avp',
            for k=1:kk
                ...
                err(:,3)=-err(:,3);
                t = t-TB;
                subplot(322), hold on, plot(t, err(:,1:3)/glv.deg, strk, 'LineWidth',2); xygo('att'); mylegend([phi_mu,'x'],[phi_mu,'y'],[phi_mu,'z']);
